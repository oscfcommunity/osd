        ...
        <nav className="space-y-4">
          ...
          <div className="pt-6 border-t border-gray-700">
            <a
              ...
              className="mobile-menu-item block w-full bg-green-500 hover:bg-green-400 text-black text-center py-3 px-4 rounded-lg font-semibold transition-all duration-200"
              onClick={onClose}
            >
              Register Now
            </a>
